...
octave-forge and Matlab. The supported version of Octave is 2.1.73. Other
versions of Octave might work. This program has been tested on Windows and
Linux, but it should work on any platform for which Java and Octave or Matlab
are available.
...
Octave may be tested by typing "octave-2.1.73" to command line. If octave
...
switch "-q". The file must be in the directory containing xrr.jar. On Windows
...
searched from. If you are unable or unwilling to install the library there,
you have to adjust LD_LIBRARY_PATH. An example Makefile is included, which
works on the Linux computers of TKK's computing centre. You will almost
certainly need to adjust this file.
