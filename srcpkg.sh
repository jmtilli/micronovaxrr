...
cp deploy/LICENSE.txt deploy/README* deploy/resolution.txt deploy/jfreechart-1.0.1.jar deploy/uncommons-maths-1.2.3.jar deploy/javafastcomplex.jar deploy/atomic_masses.txt xrr-src/deploy
